 ...
 */
final class Version20200321185154 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE patient ADD organ_donation VARCHAR(255) NOT NULL, CHANGE hospital_id hospital_id INT DEFAULT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE matching_test CHANGE patient_id patient_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE medicine_request CHANGE donor_id donor_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE patient DROP organ_donation, CHANGE hospital_id hospital_id INT DEFAULT NULL');
