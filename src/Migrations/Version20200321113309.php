 ...
 */
final class Version20200321113309 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE doctor_request_donor (doctor_request_id INT NOT NULL, donor_id INT NOT NULL, INDEX IDX_B1A1346E3DD7B7A7 (donor_id), INDEX IDX_B1A1346E75699134 (doctor_request_id), PRIMARY KEY(doctor_request_id, donor_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        $this->addSql('CREATE TABLE medicine_request_donor (medicine_request_id INT NOT NULL, donor_id INT NOT NULL, INDEX IDX_A174A1733DD7B7A7 (donor_id), INDEX IDX_A174A1731ED7F277 (medicine_request_id), PRIMARY KEY(medicine_request_id, donor_id)) DEFAULT CHARACTER SET utf8 COLLATE `utf8_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
